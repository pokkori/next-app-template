    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
        ...
        <p className="text-xs text-gray-400 mt-4 text-center">
          <svg className="inline w-3 h-3 mr-1 text-gray-400" viewBox="0 0 12 12" fill="none" aria-hidden="true"><rect x="2" y="5" width="8" height="6" rx="1.5" stroke="currentColor" strokeWidth="1.2"/><path d="M4 5V3.5a2 2 0 0 1 4 0V5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>カード情報はPAY.JP（PCI DSS準拠）で安全に処理されます。当サービスには保存されません。
        </p>
      </div>
    </div>
  );
